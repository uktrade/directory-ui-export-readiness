...
# Market Access
CONTACT_MARKET_ACCESS_ZENDESK_SUBJECT = env.str(
    'CONTACT_MARKET_ACCESS_ZENDESK_SUBJECT', 'great.gov.uk report market access barrier'
)
MARKET_ACCCESS_ZENDESK_SUBDOMAIN = env.str('MARKET_ACCCESS_ZENDESK_SUBDOMAIN')
MARKET_ACCESS_FORMS_API_ZENDESK_SEVICE_NAME = env.str(
    'MARKET_ACCESS_FORMS_API_ZENDESK_SEVICE_NAME', 'MarketAccess'
)
