...
CONTACT_INVEST_AGENT_NOTIFY_TEMPLATE_ID = env.str(
    'CONTACT_INVEST_AGENT_NOTIFY_TEMPLATE_ID'
)
CONTACT_INVEST_AGENT_EMAIL_ADDRESS = env.str(
    'CONTACT_INVEST_AGENT_EMAIL_ADDRESS'
)
CONTACT_INVEST_USER_NOTIFY_TEMPLATE_ID = env.str(
    'CONTACT_INVEST_USER_NOTIFY_TEMPLATE_ID'
)
