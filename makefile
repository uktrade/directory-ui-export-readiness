...
DOCKER_SET_DEBUG_ENV_VARS := \
	...
	export DIRECTORY_UI_EXPORT_READINESS_UTM_COOKIE_DOMAIN=.great; \
	...
	export DIRECTORY_UI_EXPORT_READINESS_SERVICES_FAB=http://buyer.trade.great:8001; \
	export DIRECTORY_UI_EXPORT_READINESS_SERVICES_GET_FINANCE=/get-finance; \
	export DIRECTORY_UI_EXPORT_READINESS_SERVICES_SOO=http://soo.trade.great:8008; \
...
DEBUG_SET_ENV_VARS := \
	...
	export RECAPTCHA_PUBLIC_KEY=6Lc9EC4UAAAAAOFaExlfAkHhS_l6k_sBFTTNPDPD; \
	export RECAPTCHA_PRIVATE_KEY=6Lc9EC4UAAAAAFdtUrYH78fXHNK8QqFoXBDyZDYQ; \
