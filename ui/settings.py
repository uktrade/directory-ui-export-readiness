...
import os
# import all production urls from directory_constants
...
# HEADER/FOOTER URLS
GREAT_EXPORT_HOME = os.getenv('GREAT_EXPORT_HOME', urls.GREAT_EXPORT_HOME)

# EXPORTING PERSONAS
EXPORTING_NEW = os.getenv('EXPORTING_NEW', urls.EXPORTING_NEW)
EXPORTING_REGULAR = os.getenv('EXPORTING_REGULAR', urls.EXPORTING_REGULAR)
...
GUIDANCE_MARKET_RESEARCH = os.getenv(
    'GUIDANCE_MARKET_RESEARCH', urls.GUIDANCE_MARKET_RESEARCH)
GUIDANCE_CUSTOMER_INSIGHT = os.getenv(
    'GUIDANCE_CUSTOMER_INSIGHT', urls.GUIDANCE_CUSTOMER_INSIGHT)
GUIDANCE_FINANCE = os.getenv('GUIDANCE_FINANCE', urls.GUIDANCE_FINANCE)
GUIDANCE_BUSINESS_PLANNING = os.getenv(
    'GUIDANCE_BUSINESS_PLANNING', urls.GUIDANCE_BUSINESS_PLANNING)
GUIDANCE_GETTING_PAID = os.getenv(
    'GUIDANCE_GETTING_PAID', urls.GUIDANCE_GETTING_PAID)
GUIDANCE_OPERATIONS_AND_COMPLIANCE = os.getenv(
    'GUIDANCE_OPERATIONS_AND_COMPLIANCE',
    urls.GUIDANCE_OPERATIONS_AND_COMPLIANCE)

# SERVICES
SERVICES_EXOPPS = os.getenv('SERVICES_EXOPPS', urls.SERVICES_EXOPPS)
SERVICES_FAB = os.getenv('SERVICES_FAB', urls.SERVICES_FAB)
SERVICES_GET_FINANCE = os.getenv(
    'SERVICES_GET_FINANCE', urls.SERVICES_GET_FINANCE)
SERVICES_SOO = os.getenv('SERVICES_SOO', urls.SERVICES_SOO)
